...
class ManufacturerVariableAccessorTest {
    ...
    static Stream<Arguments> SetVariableDataProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, ManufacturerVariableAccessor.NAME, SetVariableStatusEnum.REJECTED),
                arguments(MAX_SET_ATTRIBUTE, ManufacturerVariableAccessor.NAME, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(MIN_SET_ATTRIBUTE, ManufacturerVariableAccessor.NAME, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(TARGET_ATTRIBUTE, ManufacturerVariableAccessor.NAME, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatusEnum.ACCEPTED, StationHardwareData.VENDOR_NAME),
