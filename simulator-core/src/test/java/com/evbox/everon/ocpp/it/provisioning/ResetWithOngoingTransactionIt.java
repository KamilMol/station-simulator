...
import static com.evbox.everon.ocpp.v20.message.BootReasonEnum.REMOTE_RESET;
...
public class ResetWithOngoingTransactionIt extends StationSimulatorSetUp {
    ...
    void shouldImmediatelyResetWithOngoingTransaction() {
        ...
        Call call = new Call(DEFAULT_CALL_ID, ActionType.RESET, new ResetRequest().withType(ResetEnum.IMMEDIATE));
