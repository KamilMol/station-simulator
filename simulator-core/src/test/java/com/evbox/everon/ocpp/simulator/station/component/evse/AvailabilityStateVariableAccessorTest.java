...
class AvailabilityStateVariableAccessorTest {
    ...
    static Stream<Arguments> SetVariableDataProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, AvailabilityStateVariableAccessor.EVSE_AVAILABILITY, SetVariableStatusEnum.REJECTED),
                arguments(MAX_SET_ATTRIBUTE, AvailabilityStateVariableAccessor.EVSE_AVAILABILITY, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(MIN_SET_ATTRIBUTE, AvailabilityStateVariableAccessor.EVSE_AVAILABILITY, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(TARGET_ATTRIBUTE, AvailabilityStateVariableAccessor.EVSE_AVAILABILITY, SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE)
        );
    }
    ...
    static Stream<Arguments> getVariableDatumProvider() {
        ...
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatusEnum.ACCEPTED, AvailabilityStateVariableAccessor.EVSE_AVAILABILITY),
    ...
    static AttributePath.AttributePathBuilder attributePathBuilder(int evseId) {
        return AttributePath.builder()
                .component(new Component().withName(new CiString.CiString50(COMPONENT_NAME))
                        .withEvse(new com.evbox.everon.ocpp.v20.message.EVSE().withId(evseId))
                )
