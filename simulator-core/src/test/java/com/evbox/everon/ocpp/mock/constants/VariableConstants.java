...
public class VariableConstants {
    ...
    // component names
    public static final String SECURITY_COMPONENT_NAME = "SecurityCtrlr";
    public static final String TRANSACTION_COMPONENT_NAME = "TxCtrlr";
    public static final String COMM_COMPONENT_NAME = "OCPPCommCtrlr";
