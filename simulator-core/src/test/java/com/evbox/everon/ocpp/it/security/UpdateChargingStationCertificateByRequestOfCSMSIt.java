...
public class UpdateChargingStationCertificateByRequestOfCSMSIt extends StationSimulatorSetUp {
    ...
    void shouldRequestNewCertificate() throws IOException {
        ...
        TriggerMessageRequest triggerMessageRequest = new TriggerMessageRequest()
                                                            .withRequestedMessage(MessageTriggerEnum.SIGN_CHARGING_STATION_CERTIFICATE);
        ...
        assertThat(triggerResponse.getStatus().value()).isEqualTo(TriggerMessageStatusEnum.ACCEPTED.value());

        CertificateSignedRequest certificateSignedRequest = new CertificateSignedRequest()
                .withCertificateChain(stringToCiStringsList(certificate));
        ...
        assertThat(certificateResponse.getStatus().value()).isEqualTo(CertificateSignedStatusEnum.ACCEPTED.value());
