...
class IdentityVariableAccessorTest {
    ...
    private static final String VARIABLE_NAME = IdentityVariableAccessor.NAME;
    ...
    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatusEnum.ACCEPTED, STATION_IDENTITY_CODE),
