...
class ModelVariableAccessorTest {
    ...
    private static final String VARIABLE_NAME = ModelVariableAccessor.NAME;
    ...
    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatusEnum.ACCEPTED, StationHardwareData.MODEL),
