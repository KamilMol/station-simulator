...
class ChargeProtocolVariableAccessorTest {
    ...
    private static final String VARIABLE_NAME = ChargeProtocolVariableAccessor.NAME;
    ...
    static Stream<Arguments> SetVariableDataProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, "some_value", SetVariableStatusEnum.REJECTED),
                arguments(MAX_SET_ATTRIBUTE, "some_value", SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(MIN_SET_ATTRIBUTE, "some_value", SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE),
                arguments(TARGET_ATTRIBUTE, "some_value", SetVariableStatusEnum.NOT_SUPPORTED_ATTRIBUTE_TYPE)
        );
    }

    static Stream<Arguments> getVariableDatumProvider() {
        return Stream.of(
                arguments(ACTUAL_ATTRIBUTE, GetVariableStatusEnum.ACCEPTED, StationHardwareData.PROTOCOL_VERSION),
