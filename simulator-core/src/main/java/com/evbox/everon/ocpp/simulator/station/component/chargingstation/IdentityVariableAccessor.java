...
public class IdentityVariableAccessor extends VariableAccessor {
    ...
    private final ImmutableMap<AttributeType, VariableGetter> variableGetters = ImmutableMap.<AttributeType, VariableGetter>builder()
    ...
    public IdentityVariableAccessor(Station station, StationStore stationStore) {
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(getStation().getConfiguration().getId()))
