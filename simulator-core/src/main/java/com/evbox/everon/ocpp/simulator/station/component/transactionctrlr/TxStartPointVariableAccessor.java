...
public class TxStartPointVariableAccessor extends VariableAccessor {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(String.valueOf(getStationStore().getTxStartPointValues())))
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(String.valueOf(getStationStore().getTxStartPointValues())));
    }
}
