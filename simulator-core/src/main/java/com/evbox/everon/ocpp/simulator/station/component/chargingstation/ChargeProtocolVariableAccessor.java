...
public class ChargeProtocolVariableAccessor extends VariableAccessor {
    ...
    public List<ReportData> generateReportData(String componentName) {
        ...
        VariableAttribute variableAttribute = new VariableAttribute()
                .withValue(new CiString.CiString2500(StationHardwareData.PROTOCOL_VERSION))
                .withPersistent(true)
                .withConstant(true)
    ...
    private GetVariableResult getActualValue(AttributePath attributePath) {
        return new GetVariableResult()
                ...
                .withAttributeValue(new CiString.CiString2500(StationHardwareData.PROTOCOL_VERSION))
